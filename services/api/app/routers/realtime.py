            ...
            if body.story_id:
                ...
                if story_data:
                    ...
                    instructions += (
                        ...
                        "When they are happy with the final version: first SAY one short sentence that you're saving and it will take a few seconds so they know to wait; then call confirm_story with the exact story text; after the tool returns, SAY that it's saved and they can find it in Recall past stories and move it to Shared Memories when ready."
                    )
            ...
            # Build 3: recall a specific session (or "Turn into story" from a conversation)
                ...
                if recalled_data:
                    ...
                    instructions += (
                        ...
                        "When they say they are happy with it (e.g. 'that's good', 'save it'): first SAY one short sentence that you're saving the story and it will take a few seconds so they know to wait; then call confirm_story with the exact final story text; after the tool returns, SAY that it's saved and they can find it in Recall past stories and move it to Shared Memories when ready. "
